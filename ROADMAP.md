...
- schema normalization for discriminated unions, object/array multi-type arrays, and remaining additionalProperties edge cases
...
- plugin hooks
- richer auth presets
- registry publishing helpers

## Product rule

Every roadmap item must improve one of these:
